...
fn parse_sleep_time(arg: &str, client: &mut crate::internal::client::Client) -> Result<(), String> {
    match arg.parse::<u32>() {
        Ok(n) => {
            client.sleep_time = n;
            Ok(())
...
fn parse_jitter(arg: &str, client: &mut crate::internal::client::Client) -> Result<(), String> {
    match arg.parse::<f64>() {
        Ok(n) => {
...
pub(crate) fn sleep(args: &[String], client: &mut crate::internal::client::Client) -> String {
    match args.len() {
        1 => {
